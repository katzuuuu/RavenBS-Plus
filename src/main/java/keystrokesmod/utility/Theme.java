...
public enum Theme {
    ...
    Red(new Color(121, 0, 0), new Color(255, 0, 0)); // 10
    ...
    public static String[] themes = new String[]{"Rainbow", "Cherry", "Cotton candy", "Flare", "Flower", "Gold", "Grayscale", "Royal", "Sky", "Vine", "Red"};
}
